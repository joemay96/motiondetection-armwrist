...
SF1eFilter *aXFilter = SF1eFilterCreateWithConfig(120.0, 1.0, 0.08, 1.0);
...
SF1eFilter *gXFilter = SF1eFilterCreate(120.0, 0.5, 0.05, 1.0);
SF1eFilter *gYFilter = SF1eFilterCreate(120.0, 1.0, 0.08, 1.0);
SF1eFilter *gZFilter = SF1eFilterCreate(120.0, 1.0, 0.08, 0.02);
...
void loop() {
  ...
  while (samplesRead == numSamples) {
    ...
    float aZ = SF1eFilterDo(aZFilter, IMU.readFloatAccelZ() - 1.00); 
